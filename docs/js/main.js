...
/* harmony import */ var _inputs_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./inputs.js */ "./src/js/components/inputs.js");
...
const initForms = () => {
  ...
  formElements.forEach((form, index) => {
    ...
    (0,_functions_validate_forms_js__WEBPACK_IMPORTED_MODULE_0__.validateForms)(`.${formClass}`, rules, [], () => {
      (0,_inputs_js__WEBPACK_IMPORTED_MODULE_1__.clearFields)();
    });
  });
};
initForms();
...
const getModalIdByButtonText = text => {
  ...
  if (normalized.includes("консультац") || normalized.includes("обратный звонок")) {
